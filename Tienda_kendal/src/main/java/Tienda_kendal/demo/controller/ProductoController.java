...
import org.springframework.beans.factory.annotation.Autowired; // Necesaria para @Autowired
...
public class ProductoController {
    ...
    // Se cambia a inyección por campo con @Autowired según la imagen
    @Autowired
    ...
    // Aunque no aparece explícitamente en la captura de las líneas 28-29, 
    // se suele mantener para los mensajes de respuesta.
    @Autowired
    ...
    public String modificar(@PathVariable("idProducto") Integer idProducto, Model model, RedirectAttributes redirectAttributes) {
        ...
        // Líneas 81-82 actualizadas según la imagen
        var categorias = categoriaService.getCategorias(true);
        model.addAttribute("categorias", categorias);
